...
// In this script, participants were randomly assigned to different instruction conditions
// This code randomly set a participant's group ID, and controlled the instructions they saw. 
// Random assignment of Turkers to instructions
// Using strategy developed by Michael Wilson (UMass Amerst), 2017
var x = Math.random();
if (x < 0.25) {
  var groupID = "groupA";
...
/// Instructions and practice for Group A.
/// Group A is told that 4/5 are bad. Practice items are 4/5 bad. 

['groupA', "Form", {consentRequired: false, html: {include: "groupA_intro4.html"}}],

//['groupA', Message, {consentRequired: false,
//                   html: ["div",
//                           ["p", "There are no right or wrong answers; many speakers have different intuitions about whether a sentence sounds right or wrong, and that's perfectly natural. However, based on previous work, we expect people to find about 80% of the sentences in this experiment, or 4 in 5, to be bad. So you should expect to see lots of ungrammatical or unusual sentences."],
//                           ["p", "Let's try one practice item."]
//                         ]}],

["groupA", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Those cats was snoring loudly."}],
...
["groupA", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "At the ball, the prince waltzed with girl every before midnight."}],
["groupA", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Without warning, Geoffrey turned and screamed at the waiter who embarrassed him."}],
["groupA", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Madame de Plessy has sitted up all night worrying about her son, who was fighting the invaders."}],
["groupA", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "The barista lazily made a lattes and didn't even try to make a design on top."}],
...
/// Instructions and practice for Group B.
/// Group B is told that 3/5 are bad. Practice items are 3/5 bad. 

['groupB', "Form", {consentRequired: false, html: {include: "groupB_intro4.html"}}],

//['groupB', Message, {consentRequired: false,
//                   html: ["div",
//                           ["p", "There are no right or wrong answers; many speakers have different intuitions about whether a sentence sounds right or wrong, and that's perfectly natural. However, based on previous work, we expect people to find about 60% of the sentences in this experiment, or 3 in 5, to be bad. So you should expect to see lots of ungrammatical or unusual sentences."],
//                           ["p", "Let's try one practice item."]
//                         ]}],

["groupB", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Those cats was snoring loudly."}],
...
["groupB", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "At the ball, the prince waltzed with girl every before midnight."}],
["groupB", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Without warning, Geoffrey turned and screamed at the waiter who embarrassed him."}],
["groupB", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Madame de Plessy has sitted up all night worrying about her son, who was fighting the invaders."}],
["groupB", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "The barista lazily made a latte and didn't even try to make a design on top."}],
...
/// Instructions and practice for Group C.
/// Group C is told that 3/5 are good. Practice items are 3/5 good. 

['groupC', "Form", {consentRequired: false, html: {include: "groupC_intro4.html"}}],

//['groupC', Message, {consentRequired: false,
//                   html: ["div",
//                           ["p", "There are no right or wrong answers; many speakers have different intuitions about whether a sentence sounds right or wrong, and that's perfectly natural. However, based on previous work, we expect people to find about 60% of the sentences in this experiment, or 3 in 5, to be good. So you should expect to see lots of natural, grammatical sentences."],
//                           ["p", "Let's try one practice item."]
//                         ]}],

["groupC", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Those cats were snoring loudly."}],
...
["groupC", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "At the ball, the prince waltzed with every girl before midnight."}],
["groupC", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Without warning, Geoffrey turned and screamed at the waiter who embarrassed itself."}],
["groupC", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Madame de Plessy has sitted up all night worrying about her son, who was fighting the invaders."}],
["groupC", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "The barista lazily made a latte and didn't even try to make a design on top."}],
...
/// Instructions and practice for Group D.
/// Group D is told that 4/5 are good. Practice items are 4/5 good. 

['groupD', "Form", {consentRequired: false, html: {include: "groupD_intro4.html"}}],

//['groupD', Message, {consentRequired: false,
//                   html: ["div",
//                           ["p", "There are no right or wrong answers; many speakers have different intuitions about whether a sentence sounds right or wrong, and that's perfectly natural. However, based on previous work, we expect people to find about 80% of the sentences in this experiment, or 4 in 5, to be good. So you should expect to see lots of natural, grammatical sentences."],
//                           ["p", "Let's try one practice item."]
//                         ]}],

["groupD", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Those cats were snoring loudly."}],
...
["groupD", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "At the ball, the prince waltzed with every girl before midnight."}],
["groupD", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Without warning, Geoffrey turned and screamed at the waiter who embarrassed itself."}],
["groupD", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "Madame de Plessy sat up all night worrying about her son, who was fighting the invaders."}],
["groupD", Separator, { transfer: 1000, normalMessage: "+", errorMessage: "Timed out. Please respond more quickly."}, DS, {s: "The barista lazily made a latte and didn't even try to make a design on top."}],
