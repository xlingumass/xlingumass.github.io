...
jqueryWidget: {
    _init: function () {
        var opts = {
            ...
            triggers:    [1],
            children:    [this.options._dashed ? "EPDashedSentence" : "FlashSentence",
                          this.options._dashed ? {
                                                     ...
                                                     characterTimeAdd: this.options.characterTimeAdd
                                                 } :
                                                 {
                                                     s: this.options.s,
                          ...
                          this.options._dashed ? "!QuestionAlt" : (this.options.s.audio ? "*QuestionAlt" : "QuestionAlt"),
                          { q:                   this.options.q,
                            as:                  this.options.as,
...
properties: {
    ...
    htmlDescription:
        function (opts) {
            ...
            var q = ibex_controller_get_property("QuestionAlt", "htmlDescription")(opts);
            var p =
                $("<p>")
